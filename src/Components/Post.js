...
export default class extends Component {
    ...
    fetch('http://91.225.165.43:3001/post'+url)
        ...
        .then(post => {
            if(post.length === 0){
                this.setState({ wrongAddres: true })
                return
            }
        ...
        .then((author) => {
            fetch('http://91.225.165.43:3001/author/'+author)
            .then(res => res.json())
    ...
    render(){
        ...
        return(
            <div className="Post">
            {
                this.state.post && this.state.meta && 
                <MetaTags>
                        ...
                        this.state.visibility?(
                            <div className="d_post">
                                ...
                                <div className="post_title_info">
                                    <div className="author_info">
                                        ...
                                        <div className="author_photo_circle">
                                        {this.state.author && <img src={"http://91.225.165.43:3001/" + this.state.author.img}/>}
                                        </div>
                            ...
                            <div className="post_mobile">
                                ...
                                <div className="m_post_box">
                                    ...
                                    <img src={"http://91.225.165.43:3001/"+this.state.post.postImage} className="m_post_img"/>
                                    <div className="m_post_info">
                                        <div className="m_post_author_info_box">
                                            <div className="m_post_info_circles">
                                                {this.state.author && <img className="m_post_author_circle" src={"http://91.225.165.43:3001/" + this.state.author.img}/>}
                                                <div className="m_post_right_circle"></div>
                                                <div className="m_post_bottom_circle"></div>
                                            </div>
                                            <div className="m_post_author_name">
                                                <h2>{this.state.author && this.state.author.name}</h2>
                                            </div>
                                        </div>
