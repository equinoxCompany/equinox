...
import { desktopStyles, mobileStyles } from './MapStyles';
    ...
    if (this.state.visibility) {
      ...
      setTimeout(() => {
        ...
        for (var i = 0, child; child = info_circle_a[i]; i++) {
          if(i == 1){
            child.classList.add("increaseUpperCircleLi");
          }else{
          ...
          {this.state.visibility ? (
            <div>
              ...
              <div className="text_we_are_here">
                <h1>МІСЦЕ</h1>
                <h2 style={{ color: "rgb(270, 92, 20)" }}>ЗАРОДЖЕННЯ</h2>
                <h1>ІДЕЙ</h1>
              </div>
              <div className="contact_info">
                <div></div>
                <h1>вул. Воздвиженська 36</h1>
                <h2>Тут зароджується краса<br/> інтернет простору</h2>
              </div>
              <div className="contacts_address">
                ...
                <div className="contacts_address_info">
                  <h1>ЗАВІТАЙТЕ <span style={{ color: 'rgb(270, 92, 20' }}>ДО НАС </span> В ГОСТІ</h1>
                  <div></div>
                  <div className="address_info left">
                    ...
                    <div onClick={() => this.setMap(true)}>
                      <h3>Відкрити карту</h3>
                      <div></div>
                    </div>
                  </div>
                  <div className="address_info right">
                    <h3>36, вул. Воздвиженська, Київ, 04071</h3>
                    <h3>FG56+RJ Київ</h3>
                    <h3>50.4595523, 30.5093612</h3>
                  </div>
                </div>
              </div>
              <div className="contacts_address_bottom">
                <div>
                  <ul>
                    <li><Link to="/join-the-crew" style={{ textDecoration: 'none', color: 'white' }}>Приєднатись</Link></li>
                    <li><a>Розпочати проект</a></li>
                    <li><a>Сказати привіт</a></li>
                  </ul>
                </div>
                <div className="contacts_address_bottom_text">
                  <div>
                  </div>
                  <h3>Ми перестали уявляти своє життя без <span style={{ color: 'rgb(270, 92, 29)' }}>креативу.</span></h3>
                  <h3>Ми завжди раді новим можливостям створити щось дивовижне.</h3>
                  <h3>Напишіть нам – і ми разом з Вами розмалюємо інтернет простір барвами!</h3>
                </div>
              </div>
              <Socials />
            </div>
            ...
            (<div>
              ...
              <section className="m_contacts_map">
                <CompanyMap styles={mobileStyles}></CompanyMap>
              </section>
              <section className="m_contacts_address">
                <p>Vozdvyzhens'ka St, 36, Kyiv, 04071</p>
                <p>+380961999932</p>
                <p>equinox@gmail.com</p>
              </section>
              <MobileContactsMenuNav />
              <div className="m_contacts_address_circle">
                <p>FG56+RJ Kyiv, Kyiv city <br />50.459548, 30.511555</p>
              </div>
